...
const Process = () => {
  ...
  const steps = [
    ...
    },
    {
      icon: CheckCircle2,
      number: "03",
      title: "Zero-Cost Build",
      description: "Your custom website & app built at zero development cost. Pay only the security advance and monthly retainer."
    },
    {
      icon: Rocket,
      number: "04",
      title: "Growth Partnership",
      description: "We don't just hand you a website & app and walk away. Monthly strategic support to help your business grow."
    }
  ];
